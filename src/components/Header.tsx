...
export function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 h-16 border-b border-border bg-bg-dark/80 backdrop-blur-md" style={{ zIndex: 2000 }} style={{ paddingTop: 'env(safe-area-inset-top)', paddingLeft: 'env(safe-area-inset-left)', paddingRight: 'env(safe-area-inset-right)' }}>
